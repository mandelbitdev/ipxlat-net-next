...
RET=0
ipxlat_run_iperf "$NS4" "$NS6" "$IPXLAT_V6_NS4" 5303 -B "$IPXLAT_V6_NS6_SRC" -n 8M
...
ipxlat_capture_pkts "$NS6" "icmp6 and ip6[40] == 128" 0 5 \
	...
	"ping -M \"dont\" -s 2000 -c 1 -W 1 \"$IPXLAT_V4_REMOTE\" >/dev/null 2>&1 || test \$? -eq 1"
...
ipxlat_capture_pkts "$NS4" "icmp and icmp[0] == 8" 0 5 \
	...
	"ping -6 -s 2000 -c 1 -W 1 -I \"$IPXLAT_V6_NS6_SRC\" \"$IPXLAT_V6_NS4\" >/dev/null 2>&1 || test \$? -eq 1"
