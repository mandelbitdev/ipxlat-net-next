...
/**
 * ipxl_64_convert_addrs - translate outer IPv6 endpoints into IPv4 pair
...
/**
 * ipxl_46_convert_addrs - translate outer IPv4 endpoints into IPv6 pair
 * @cfg: translator configuration
 * @iph4: source IPv4 header
 * @iph6: output IPv6 header (only saddr/daddr are updated)
 */
static inline void ipxl_46_convert_addrs(const struct ipxl_cfg *cfg,
