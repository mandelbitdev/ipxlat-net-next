...
An ipxlat netdevice can be created and configured using YNL like so::
    ...
    $ ADDR_HEX=$(python3 -c 'import ipaddress, sys; print(ipaddress.IPv6Address(sys.argv[1]).packed.hex())' 64:ff9b:: | tee /dev/stderr)
...
.. _I-D-dummy: https://datatracker.ietf.org/doc/html/draft-ietf-v6ops-icmpext-xlat-v6only-source-01
...
If I-D-WKP-1918_ makes it throught the IETF process this complication for
...
- Per `RFC 7915
  <https://datatracker.ietf.org/doc/html/rfc7915#section-4.5#:~:text=A stateless translator>`_,
...
- Per `RFC 6146
  <https://datatracker.ietf.org/doc/html/rfc6146#section-3.4#:~:text=carrying%20UDP%20packets%20with%20a%20zero>`_,
